...
export const ButtonAddNewTitle = 'Add New';
export const ButtonAddNewListTitle = 'Add New Wishlis';
export const ButtonAgreeTitle = 'Agree';
export const ButtonDeleteTitle = 'Delete';
export const ButtonBackTitle = 'Back';
export const ButtonEditTitle = 'Edit';
...
export const ManageAddressTitle = 'manage addresses';
