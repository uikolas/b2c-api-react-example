...
import { getPaymentMethodsFormSettings } from 'src/shared/helpers/formCreations/checkout/paymentSettings';
import { checkFormValidity } from 'src/shared/helpers/checkout';
import {
    IPaymentMethod,
