...
const WishlistItemBaseInfoComponent: React.SFC<Props> = ({classes, productItem}) => (
  <div className={ classes.product }>
    <span className={ classes.wrapProductImage }>
      <img src={ productItem.image } height={ 42 } width={ 42 }/>
    </span>
    <div className={ classes.productDescription }>
      <span className={ classes.tableAction } onClick={ this.renderProduct(productItem.sku, productItem.name) }>
        { productItem.name }
      </span>
