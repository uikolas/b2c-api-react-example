...
import {IOrderTotals} from "../../../../interfaces/order/index";
...
export const shipmentTitle = "Shipment Express: ";
...
export const OrderDetailsTotalsBase: React.SFC<OrderDetailsTotalsProps> = (props): JSX.Element => {
  const {classes, currency, canceledTotal, expenseTotal, discountTotal, taxTotal, subtotal, grandTotal} = props;
  ...
  return (
    <Grid container justify="flex-end" className={classes.root}>
      <Grid item xs={12}>
        ...
        {renderTotalItem(expenseTotal, shipmentTitle)}
