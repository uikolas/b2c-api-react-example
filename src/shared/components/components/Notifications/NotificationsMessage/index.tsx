...
import { NotificationsMessageTemplate } from '@components/components/Notifications/NotificationsMessageTemplate';
...
} from 'src/shared/constants/notifications/index';
